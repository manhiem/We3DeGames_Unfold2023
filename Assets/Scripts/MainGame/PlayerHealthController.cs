...
{
    [SerializeField] private NetworkPrefabRef tokenPrefabs = NetworkPrefabRef.Empty;
    ...
    public void PlayerGotHit(int healthAmount)
    {
    ...
    public void SpawnTokens()
    {
        ...
        tokenSpawner.SpawnKilledTokens(transform);
    }
